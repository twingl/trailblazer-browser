...
;(function(window, document){
  ...
  SvgPanZoom.prototype.handleMouseWheel = function(evt) {
    ...
    if (evt.target.tagName === 'svg' || evt.target.tagName === 'SVG') {
      ...
      if (evt.target.ownerSVGElement || (evt.target.correspondingElement && evt.target.correspondingElement.ownerSVGElement)) {
        svg = evt.target.ownerSVGElement || evt.target.correspondingElement.ownerSVGElement;
      } else {
        var t = evt.target;
        while (!t.ownerSVGElement && !(t.correspondingElement && t.correspondingElement.ownerSVGElement)) {
          t = t.parentElement;
        }
        svg = t.ownerSVGElement || t.correnspondingElement.ownerSVGElement;
      }
    }

    var relativeMousePoint = SvgUtils.getRelativeMousePoint(svg, evt)
