    ...
    update: function() {
      ...
      pan = (function(_this) {
        return function(coords) {
          if (coords) {
            _this.set('currentViewCenter', [(window.innerWidth / 2) - coords[0], (window.innerHeight / 2) - coords[1] - 64]);
          }
          zoom.translate([(window.innerWidth / 2) - _this.get('currentViewCenter')[0], (window.innerHeight / 2) - _this.get('currentViewCenter')[1] - 64]);
          return container.transition().duration(300).ease(d3.ease("cubic-out")).attr("transform", "translate(" + [(window.innerWidth / 2) - _this.get('currentViewCenter')[0], (window.innerHeight / 2) - _this.get('currentViewCenter')[1] - 64] + ")scale(" + (zoom.scale()) + ")");
        };
      })(this);
      pan();
      ...
      return force.on("end", (function(_this) {
        return function() {
          ...
          return console.log(_.collect(nodes, function(n) {
            return [n.x, n.y];
          }));
        };
      })(this));
